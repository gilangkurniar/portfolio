    ...
    return (
        <div className='about'>
            <Container>
                ...
                <p>If you wanna see my projects, just go to "Projects" tab, or simply just click <a href="/projects" className='fw-semibold'>here.</a> If you wanna know more about me, you can download my CV <a href="https://drive.google.com/file/d/1xsNexn1MQ0UjkYlcrLqCa23gllxhdKo6/view?usp=sharing" target='_blank' className='fw-semibold'>here.</a> Also feel free to contact me! we can do some projects together as a team, or maybe you want to hire me to work in your office, just text me on "Contact" tab, or simply just click <a href="/contact" className='fw-semibold'>here.</a></p>
            </Container>
        </div>
    )
}
